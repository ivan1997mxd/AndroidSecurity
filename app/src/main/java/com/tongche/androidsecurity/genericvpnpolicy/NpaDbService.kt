    ...
    fun read(): ArrayList<Report> {
        ...
        try {
            ...
            while (it.hasNext()) {
                ...
                val state_map = report_map.get("state") as Map<String, Double>
                val harmless = state_map.get("harmless")!!.toInt()
                val type_unsupported = state_map.get("type-unsupported")!!.toInt()
                val suspicious = state_map.get("suspicious")!!.toInt()
                val confirmed = state_map.get("confirmed-timeout")!!.toInt()
                val timeout = state_map.get("timeout")!!.toInt()
                val failure = state_map.get("failure")!!.toInt()
                val malicious = state_map.get("malicious")!!.toInt()
                val undetected = state_map.get("undetected")!!.toInt()
